...
<details>
<summary><a href="./docker_level_1.md">Docker Level 1 (Tasks 1.1-1.5)</a></summary>
...
<details>
<summary><a href="./docker_level_2.md">Docker Level 2 (Tasks 2.1-2.5)</a></summary>
...
<details>
<summary><a href="./docker_level_3.md">Docker Level 3 (Tasks 3.1-3.5)</a></summary>
...
<details>
<summary><a href="./docker_level_4.md">Docker Level 4 (Tasks 4.1-4.5)</a></summary>
...
<details>
<summary><a href="./linux_level_1.md">Linux Level 1 (Tasks 1.1-1.19)</a></summary>
...
<details>
<summary><a href="./linux_level_2.md">Linux Level 2 (Tasks 2.1-1.24)</a></summary>
...
<details>
<summary><a href="./linux_level_3.md">Linux Level 3 (Tasks 3.1-3.10)</a></summary>

  - [3.1 Apache Redirects](./linux_level_3.md#31-apache-redirects)
  - [3.2 Install And Configure SFTP](./linux_level_3.md#32-install-and-configure-sftp)
  - [3.3 Install and Configure Tomcat Server](./linux_level_3.md#33-install-and-configure-tomcat-server)
  - [3.4 Linux Network Services](./linux_level_3.md#34-linux-network-services)
  - [3.5 IPtables Installation And Configuration](./linux_level_3.md#35-iptables-installation-and-configuration)
  - [3.6 Linux Nginx as Reverse Proxy](./linux_level_3.md#36-linux-nginx-as-reverse-proxy)
  - [3.7 Configure protected directories in Apache](./linux_level_3.md#37-configure-protected-directories-in-apache)
  - [3.8 Linux Process Troubleshooting](./linux_level_3.md#38-linux-process-troubleshooting)
  - [3.9 PAM Authentication For Apache](./linux_level_3.md#39-pam-authentication-for-apache)
  - [3.10 Setup SSL for Nginx](./linux_level_3.md#310-setup-ssl-for-nginx)
</details>
<details>
<summary><a href="./linux_level_4.md">Linux Level 4 (Tasks 4.1-4.9)</a></summary>

  - [4.1 Install and Configure Nginx as an LBR](./linux_level_4.md#41-install-and-configure-nginx-as-an-lbr)
  - [4.2 LEMP Troubleshooting](./linux_level_4.md#42-lemp-troubleshooting)
  - [4.3 Install and Configure Postgre SQL](./linux_level_4.md#43-install-and-configure-postgre-sql)
  - [4.4 Bash scripts if/else statements](./linux_level_4.md#44-bash-scripts-ifelse-statements)
  - [4.5 Configure LAMP server](./linux_level_4.md#45-configure-lamp-server)
  - [4.6 Install and Configure DB Server](./linux_level_4.md#46-install-and-configure-db-server)
  - [4.7 Install and Configure Web Application](./linux_level_4.md#47-install-and-configure-web-application)
  - [4.8 Install and Configure PHP-FPM](./linux_level_4.md#48-install-and-configure-php-fpm)
  - [4.9 Configure Nginx + PHP-FPM Using Unix Sock](./linux_level_4.md#49-configure-nginx--php-fpm-using-unix-sock)
</details>
...
<details>
<summary><a href="./k8s_level_1.md">Kubernetes Level 1 (Tasks 1.1-1.14)</a></summary>
...
<details>
<summary><a href="./k8s_level_2.md">Kubernetes Level 2 (Tasks 2.1-2.11))</a></summary>
...
<details>
<summary><a href="./k8s_level_3.md">Kubernetes Level 3 (Tasks 3.1-3.10)</a></summary>
...
<details>
<summary><a href="./k8s_level_4.md">Kubernetes Level 4 (Tasks 4.1-4.5)</a></summary>
...
<details>
<summary><a href="./git_level_1.md">Git Level 1 (Tasks 1.1-1.5)</a></summary>
...
<details>
<summary><a href="./git_level_2.md">Git Level 2 (Tasks 2.1-2.5)</a></summary>

  - [2.1 Git Install and Create Repository](./git_level_2.md#21-git-install-and-create-repository)
  - [2.2 Git Create Branches](./git_level_2.md#22-git-create-branches)
  - [2.3 Git Merge Branches](./git_level_2.md#23-git-merge-branches)
  - [2.4 Git Manage Remotes](./git_level_2.md#24-git-manage-remotes)
  - [2.5 Git Revert Some Changes](./git_level_2.md#25-git-revert-some-changes)
</details>
...
<details>
<summary><a href="./jenkins_level_1.md">Jenkins Level 1 (Tasks 1.1-1.5)</a></summary>
...
<details>
<summary><a href="./jenkins_level_2.md">Jenkins Level 2 (Tasks 2.1-2.5)</a></summary>
  
  - [2.1 Jenkins Views](./jenkins_level_2.md#21-jenkins-views)
  - [2.2 Jenkins Parameterized Builds](./jenkins_level_2.md#22-jenkins-parameterized-builds)
  - [2.3 Jenkins Workspaces](./jenkins_level_2.md#23-jenkins-workspaces)
  - [2.4 Jenkins Database Backup Job](./jenkins_level_2.md#24-jenkins-database-backup-job)
  - [2.5 Jenkins Scheduled Jobs](./jenkins_level_2.md#25-jenkins-scheduled-jobs)
</details>
<details>
<summary><a href="./jenkins_level_3.md">Jenkins Level 3 (Tasks 3.1-3.5)</a></summary>

  - [3.1 Jenkins Slave Nodes](./jenkins_level_3.md#31-jenkins-slave-nodes)
  - [3.2 Jenkins Project Security](./jenkins_level_3.md#32-jenkins-project-security)
  - [3.3 Jenkins Build Images](./jenkins_level_3.md#33-jenkins-build-images)
  - [3.4 Jenkins Deploy Pipeline](./jenkins_level_3.md#34-jenkins-deploy-pipeline)
  - [3.5 Jenkins Conditional Pipeline](./jenkins_level_3.md#35-jenkins-conditional-pipeline)
</details>
<details>
<summary><a href="./jenkins_level_4.md">Jenkins Level 4 (Tasks 4.1-4.5)</a></summary>

  - [4.1 Jenkins Deployment Job](./jenkins_level_4.md#41-jenkins-deployment-job)
  - [4.2 Jenkins Chained Builds](./jenkins_level_4.md#42-jenkins-chained-builds)
  - [4.3 Jenkins MR Jobs](./jenkins_level_4.md#43-jenkins-mr-jobs)
  - [4.4 Jenkins Multistage Pipeline](./jenkins_level_4.md#44-jenkins-multistage-pipeline)
  - [4.5 Jenkins Setup Node App](./jenkins_level_4.md#45-jenkins-setup-node-app)
</details>
